...
//const Asciidoctor = require('asciidoctor-loader');
const gchelpers = require("./src/_scripts/_modules/helpers.js");
const AdocLoader = require("./src/adoc-loader.js")
...
async function getConfig() {
  ...
  console.log("Defined Entries = ", entries)
  ...
  return {
    ...
    resolveLoader: {
      alias: {
        'adoc-loader': path.join(__dirname, './src/adoc-loader.js'),
      },
   },
      ...
      rules: [
        {
          ...
          use: [
             ...
             */
            {
              loader: "adoc-loader?showTitle",

            },
           /**
            {
              loader: "asciidoctor-loader?", 
              //options: { // options are now in the url, is deprecated, see also // https://github.com/webpack/loader-utils/issues/56#issuecomment-285935605
...
//               }
    ...
    plugins: [
      ...
      new CopyWebpackPlugin([
        ...
        {
          from: "src/_scripts/reveal-plugins/tex-components/*.min.js",
          to: "lib/mathjax/tex-components/[name].js"
        },
